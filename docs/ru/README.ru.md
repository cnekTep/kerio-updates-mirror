...
Если вы не хотите использовать Docker, вы можете запустить Kerio Updates Mirror без него. Для этого вам нужно будет вручную установить все зависимости и настроить систему.
...
Ccылка для скачивания сборки готового exe файла: [Kerio Updates Mirror](https://transfiles.ru/uetm1)
...
2. **Через встроенный прокси**:
    - Временно настроить встроенный прокси в Kerio Connect на адрес и порт зеркала:
...
> **Примечание**: При использовании встроенного прокси антивирус временно перестанет работать, но восстановится после отключения прокси.
